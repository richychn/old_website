...
const content = {
    ...
    <p>Currently, I am hooked by the idea of designing systems that cross digital and physical environments and use software to empower regular, physical activities, such as shopping, eating at restaurants, or going to work. </p><p> To that end, I am working with my friends to develop an app for restaurant customers. </p><p> More on that <a href="/#/blogs/0">here</a>.</p><br>\
